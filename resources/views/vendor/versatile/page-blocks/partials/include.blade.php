    ...
    <div class="panel panel-bordered panel-info @if ($block->is_minimized == 1) panel-collapsed @endif">
        <div class="panel-heading">
            ...
            <h3 class="panel-title">
                <a
                        class="panel-action panel-collapse-icon versatile-angle-up"
                        data-toggle="block-collapse"
                        style="cursor:pointer"
                >
                    {{ __('versatile-pages::generic.developer_include') }}
                </a>
            </h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info">
                            <h4>{{ __('versatile-pages::generic.how_this_works') }}</h4>
                            <p>{{ __('versatile-pages::generic.developer_include_info') }}</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                   <div class="col-md-12">
                        <div class="form-group">
                            <label>{{ __('versatile-pages::generic.path') }}</label><br>
                            <input
                                    class="form-control"
                                    type="text"
                                    name="path"
