...
class ContentFourColumnsHandler extends AbstractHandler
{
    protected $name = 'content_four_columns';

    protected $codename = 'content_four_columns';
    ...
    public function form()
    {
        ...
        $form = [
            ...
            'template' => 'v-theme::blocks.content_four_columns',
        ];
