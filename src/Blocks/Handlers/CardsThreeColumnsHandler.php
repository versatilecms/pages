...
class CardsThreeColumnsHandler extends AbstractHandler
{
    protected $name = 'cards_three_columns';

    protected $codename = 'cards_three_columns';
    ...
    public function form()
    {
        ...
        $form = [
            ...
            'template' => 'v-theme::blocks.cards_three_columns',
        ];
